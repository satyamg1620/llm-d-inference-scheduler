...
#
# This variant PULLS a pre-built EPP image from a container registry. For
# the "build the EPP image locally" variant, use start-stack-real-vllm.sh.
#
...
# Default to the image published by the x86 verification host. Override with
# EPP_IMAGE=... to point at your own registry (e.g. ghcr.io/myorg/llm-d-epp:vX.Y.Z).
EPP_IMAGE=${EPP_IMAGE:-quay.io/satyam16/llm-d-epp:baremetal}
...
log "Pulling the EPP image: $EPP_IMAGE (this is the pull-from-registry variant)"
docker pull "$EPP_IMAGE" >/dev/null
ok "$EPP_IMAGE pulled"
...
────────────────────────────────────────────────────────────────────────
  bare-metal llm-d stack (real vLLM, pulled EPP image) is up
────────────────────────────────────────────────────────────────────────
  network          $NET
